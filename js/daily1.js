...
(function() {
	...
	var feedback = {
		...
		need_help:document.getElementById('need_help'),
		ps:document.getElementById('ps'),
		imageList: document.getElementById('image-list'),
		submitBtn: document.getElementById('submit')
	};
	var url = 'http://58.242.107.76:5000/daily';
	feedback.files = [];
...
//				console.log("event:"+e);
	...
	feedback.submitBtn.addEventListener('tap', function(event) {
		...
		feedback.send(mui.extend({}, feedback.deviceInfo, {
			done: feedback.done.value,
			todo: feedback.todo.value,
			need_help: feedback.need_help.value,
			ps: feedback.ps.value,
